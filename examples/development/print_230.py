...
from AlphaTwirl.EventReader import Associator, Collector
...
for component in heppyResult.components():
    ...
    reader1 = associator1.make(component.name)
    reader2 = associator2.make(component.name)
    reader3 = associator3.make(component.name)
