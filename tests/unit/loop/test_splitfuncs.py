...
def test_file_start_length_list_empty_01():
...
def test_file_start_length_list_onefile_01():
    args = ([('A', 20)], 30, 2)
    expected = [(['A'], 0, 20)]
    assert expected == _file_start_length_list(*args)
...
def test_file_start_length_twofiles_01():
...
def test_file_start_length_twofiles_02_maxfile1():
...
def test_file_start_length_list_05():
...
def test_file_start_length_list_06():
